...
fileInput.addEventListener("change", (e) => {
  if (e.target.files.length > 0) {
    ...
    fileUpload.querySelector(".file-upload-text").textContent = "âœ“ " + fileName;
...
contactForm.addEventListener("submit", (e) => {
  ...
  btn.textContent = "âœ“ GÃ¶ndÉ™rildi!";
  btn.style.background = "linear-gradient(135deg, #10b981, #059669)";

  setTimeout(() => {
    btn.innerHTML =
      '<svg viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg> GÃ¶ndÉ™r';
